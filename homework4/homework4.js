...
const products = {
  ...
  */
  ...
  const alex = new Cashier("Alex", products);
  const klava = new Cashier("Klava", products);
  
  /* Пример использования */
  console.log("Прайс: ", products); // ссылка на базу данных продуктов (объект products)
  
  console.group(1);
  alex.transaction(order1, 300);
  console.groupEnd(1);
  
  console.group(2);
  alex.transaction(order2, 600);
  console.groupEnd(2);
  
  console.group(3);
  klava.transaction(order3, 200);
  console.groupEnd(3);
  
  console.group(4);
  klava.transaction(order4, 500);
  console.groupEnd(4);
  
  console.group(5);
  alex.transaction(order5, 650);
  console.groupEnd(5);